...
The three base classes are [Expert](#expert), [Mage](#mage), and [Warrior](#warrior). Each of these base classes has their own [HP Progression](/rules#hp-progression), attack progression, and [Feat](#feat) advancement.
